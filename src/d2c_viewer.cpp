...
D2CViewer::D2CViewer(ros::NodeHandle& nh, ros::NodeHandle& nh_private)
  ...
  image_sync_ = std::make_shared<message_filters::Synchronizer<MySyncPolicy>>(MySyncPolicy(10), rgb_sub_,
                                                                        depth_sub_);
  image_sync_->registerCallback(boost::bind(&D2CViewer::messageCallback, this, _1, _2));
